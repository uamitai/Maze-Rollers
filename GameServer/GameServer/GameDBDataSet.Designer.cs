...
namespace GameServer {
    ...
    public partial class GameDBDataSet : global::System.Data.DataSet {
        ...
        public partial class PlayersDataTable : global::System.Data.TypedTableBase<PlayersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public PlayersRow AddPlayersRow(string username, string password) {
...
namespace GameServer.GameDBDataSetTableAdapters {
    ...
    public partial class PlayersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Players] ([username], [password]) VALUES (@username, @password" +
                ");\r\nSELECT Id, username, password FROM Players WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Players] SET [username] = @username, [password] = @password WHERE (" +
                "([Id] = @Original_Id) AND ([username] = @Original_username) AND ([password] = @O" +
                "riginal_password));\r\nSELECT Id, username, password FROM Players WHERE (Id = @Id)" +
                "";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, username, password FROM dbo.Players";
        ...
        public virtual int Fill(GameDBDataSet.PlayersDataTable dataTable) {
        ...
        public virtual GameDBDataSet.PlayersDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            GameDBDataSet.PlayersDataTable dataTable = new GameDBDataSet.PlayersDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(GameDBDataSet.PlayersDataTable dataTable) {
